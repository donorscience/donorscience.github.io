...
var style_PetroleumWells_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 13.6 + size, points: 5,
            radius2: 6.8, stroke: new ol.style.Stroke({color: 'rgba(0,0,0,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(0,0,0,1.0)'})}),
...
function update() {
    ...
    var features = lyr_PetroleumWells_2.getSource().getFeatures();
