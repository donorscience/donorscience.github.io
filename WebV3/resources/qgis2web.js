...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 28, minZoom: 4, projection: 'EPSG:3857'
    })
});


    var searchLayer = new ol.SearchLayer({
      layer: lyr_FTSalaryperEmployeeData0,
      colName: 'City',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([-16418535.614488, 2657025.093914, -6794420.169905, 11502620.739633], map.getSize());
                ...
                if (doPopup) {
                    ...
                    for(var n=0; n<clusteredFeatures.length; n++) {
                        ...
                        for (var i=0; i<currentFeatureKeys.length; i++) {
                            if (currentFeatureKeys[i] != 'geometry' && layer.get('fieldAliases')[currentFeatureKeys[i]] != 'median_ft_salary') {
                                popupField = '';
